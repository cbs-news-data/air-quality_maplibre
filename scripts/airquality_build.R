...
# Export as HTML file
saveWidget(airquality_map_National, 'docs/map_AQ_National.html', title = "Air Quality Map Placeholder Title", selfcontained = TRUE)
saveWidget(airquality_map_Nationwide, 'docs/map_AQ_Nationwide.html', title = "Air Quality Map Placeholder Title", selfcontained = TRUE)
